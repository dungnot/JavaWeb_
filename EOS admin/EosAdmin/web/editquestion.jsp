...
<%-- 
    ...
    Created on : Feb 19, 2023, 10:52:05 AM
    Author     : Dũng
--%>
...
<html>
    ...
    <body>
        <div style="padding: 20%; padding-top: 10px;     ">
            <h1 style="text-align: center   ">Edit Questions </h1>    
            <form method="post" action="EditQuest">
                ...
                <label>Test: </label> <select class="form-select" name="test">
                    <c:forEach var="l" items="${list}">
                        <option value="${l.id}" ${a.id== l.id ? "selected":""}  >${l.t_name}</option>
                    </c:forEach> 
                </select>
